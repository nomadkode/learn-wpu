...
- OPERATOR
    a. Unary (membutuhkan 1 operand)
        1. typeof
            number, string, boolean
    b. Binary (membutuhkan 2 operand)
        1. aritmatika
            +, -, *, /, % (modulus)
        ...
        5. string
            concatination +
    c. Ternary (membutuhkan 3 operand)
        1. kondisional
            (kondisi) ? benar : salah
            (x % 2 == 0) ? "genap" : "ganjil"
